...
[ObjectTemplate](https://github.com/eXpandFramework/Reactive.XAF/tree/master/src/Modules/ObjectTemplate)|![](https://xpandshields.azurewebsites.net/badge/Agnostic-net5.0-yellowgreen)<br>![](https://xpandshields.azurewebsites.net/nuget/v/Xpand.XAF.Modules.ObjectTemplate.svg?label=&style=flat)![](https://xpandshields.azurewebsites.net/nuget/dt/Xpand.XAF.Modules.ObjectTemplate.svg?label=&style=flat)|The `MasterDetail` module can help you create platform agnostic master detail `XAF` views using only the Model Editor.
