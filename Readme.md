...
[Speech](https://github.com/eXpandFramework/Reactive.XAF/tree/master/src/Modules/Speech)|![](https://img.shields.io/badge/Win-net10.0-windows7.0-yellowgreen)<br>![](https://img.shields.io/nuget/v/Xpand.XAF.Modules.Speech.svg?label=&style=flat)![](https://img.shields.io/nuget/dt/Xpand.XAF.Modules.Speech.svg?label=&style=flat)|
...
[Telegram](https://github.com/eXpandFramework/Reactive.XAF/tree/master/src/Modules/Telegram)|![](https://img.shields.io/badge/Win-net10.0-windows7.0-yellowgreen)<br>![](https://img.shields.io/nuget/v/Xpand.XAF.Modules.Telegram.svg?label=&style=flat)![](https://img.shields.io/nuget/dt/Xpand.XAF.Modules.Telegram.svg?label=&style=flat)|The `Telegram` module provides a reactive, controller-less engine for integrating the Telegram messaging platform with XAF applications.
...
[Workflow](https://github.com/eXpandFramework/Reactive.XAF/tree/master/src/Modules/Workflow)|![](https://img.shields.io/badge/Win-net10.0-windows7.0-yellowgreen)<br>![](https://img.shields.io/nuget/v/Xpand.XAF.Modules.Workflow.svg?label=&style=flat)![](https://img.shields.io/nuget/dt/Xpand.XAF.Modules.Workflow.svg?label=&style=flat)|The `Workflow` module provides a reactive, controller-less engine for orchestrating complex, long-running, and scheduled business processes.
