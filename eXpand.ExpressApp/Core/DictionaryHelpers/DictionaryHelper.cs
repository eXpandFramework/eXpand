        ...
        public static void AddFields(DictionaryNode rootNode, XPDictionary dictionary)
        {
            foreach (PropertyInfoNodeWrapper customFieldInfo in GetCustomFields(rootNode))
                try
                {
                    ...
                    //                    XPClassInfo xpClassInfo = dictionary.GetClassInfo(classType);
                    //                    if (xpClassInfo.FindMember(customFieldInfo.Name) == null)
                    //                        xpClassInfo.CreateMember(customFieldInfo.Name, memberType);
                }
