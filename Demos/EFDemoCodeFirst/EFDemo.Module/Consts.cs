...
namespace EFDemo.Module {
	public static class Consts {
		...
		public static String CodeFirstMessageText =
			...
			"You can get this assembly via the NuGet gallery at http://nuget.org/packages/EntityFramework/5.0.0.\r\n" +
			"To learn how to start with Entity Framework Code First in XAF, refer to the tutorial at http://help.devexpress.com/#Xaf/CustomDocument3466.";
	}
}
