...
namespace EFDemo.Module.Web.Controllers {
    public partial class MyWebDetailViewController : WebModificationsController {
        protected override void SaveAndClose(SimpleActionExecuteEventArgs args) {
            View view = View;
            base.SaveAndClose(args);
            if(!view.IsDisposed && (view is DetailView) && (view.ObjectTypeInfo.Type == typeof(Contact))) {
                view.Close();
            }
        }
