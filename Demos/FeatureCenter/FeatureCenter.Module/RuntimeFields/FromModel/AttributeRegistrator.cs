...
namespace FeatureCenter.Module.RuntimeFields.FromModel {
    public class AttributeRegistrator : Xpand.Persistent.Base.General.AttributeRegistrator {
        public override IEnumerable<Attribute> GetAttributes(ITypeInfo typesInfo) {
            ...
            yield return new CloneModelViewAttribute(CloneViewType.DetailView, "RuntimeFieldsFromModel_DetailView");
            yield return new CloneModelViewAttribute(CloneViewType.ListView, "RuntimeFieldsFromModel_ListView") { DetailView = "RuntimeFieldsFromModel_DetailView" };
