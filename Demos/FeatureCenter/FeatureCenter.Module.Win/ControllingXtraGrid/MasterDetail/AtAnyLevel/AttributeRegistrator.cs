    ...
    public class AttributeRegistrator : Xpand.Persistent.Base.General.AttributeRegistrator {
        public override IEnumerable<Attribute> GetAttributes(ITypeInfo typesInfo) {
            if (typesInfo.Type == typeof(WinCustomer)) {
                ...
                yield return new CloneModelViewAttribute(CloneViewType.ListView, "MasterDetailAtAnyLevelCustomer_ListView");
            ...
            if (typesInfo.Type == typeof(WinOrder)) {
                yield return new CloneModelViewAttribute(CloneViewType.ListView, "MasterDetailAtAnyLevelOrder_ListView");
            ...
            if (typesInfo.Type == typeof(WinOrderLine)) {
                yield return new CloneModelViewAttribute(CloneViewType.ListView, "MasterDetailAtAnyLevelOrderLine_ListView");
            }
        }
    }
}
