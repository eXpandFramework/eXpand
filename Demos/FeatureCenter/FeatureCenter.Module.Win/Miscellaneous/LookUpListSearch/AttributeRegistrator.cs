    ...
    public class AttributeRegistrator : Xpand.Persistent.Base.General.AttributeRegistrator {
        ...
        public override IEnumerable<Attribute> GetAttributes(ITypeInfo typesInfo) {
            if (typesInfo.Type == typeof(Customer)) {
                yield return new CloneModelViewAttribute(CloneViewType.ListView, LookUpListSearch_LookupListView);
            }
            if (typesInfo.Type == typeof(Order)) {
                ...
                yield return new CloneModelViewAttribute(CloneViewType.DetailView, LookUpListSearch_DetailView);
