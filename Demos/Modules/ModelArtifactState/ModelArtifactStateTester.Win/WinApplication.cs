...
namespace ModelArtifactStateTester.Win {
    public partial class ModelArtifactStateTesterWindowsFormsApplication : WinApplication {
        ...
        private void ModelArtifactStateTesterWindowsFormsApplication_DatabaseVersionMismatch(object sender, DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs e) {
#if EASYTEST
			e.Updater.Update();
			e.Handled = true;
#else
