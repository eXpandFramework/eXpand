...
namespace AuditTrailTester.Web {
    ...
    public partial class AuditTrailTesterAspNetApplication : WebApplication { // http://documentation.devexpress.com/#Xaf/DevExpressExpressAppWebWebApplicationMembersTopicAll
        private DevExpress.ExpressApp.SystemModule.SystemModule module1;
        private DevExpress.ExpressApp.Web.SystemModule.SystemAspNetModule module2;
        private AuditTrailTester.Module.AuditTrailTesterModule module3;
        private AuditTrailTester.Module.Web.AuditTrailTesterAspNetModule module4;
        ...
        private void AuditTrailTesterAspNetApplication_DatabaseVersionMismatch(object sender, DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs e) {
#if EASYTEST
			e.Updater.Update();
			e.Handled = true;
#else
        ...
        private void InitializeComponent() {
            ...
            this.module4 = new AuditTrailTester.Module.Web.AuditTrailTesterAspNetModule();
            ...
            this.DatabaseVersionMismatch += new System.EventHandler<DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs>(this.AuditTrailTesterAspNetApplication_DatabaseVersionMismatch);
