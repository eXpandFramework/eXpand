...
call buildproject.cmd Xpand.ExpressApp.ModelAdaptor ".\Xpand\Xpand.ExpressApp.Modules\ModelAdaptor\Xpand.ExpressApp.ModelAdaptor.csproj"
...
echo Building SecurityDemo...
%msbuild% /nologo /t:Rebuild /verbosity:quiet /p:Configuration=%configuration% ".\Demos\SecurityDemo\SecurityDemo.sln"
...
echo Building E4035- Middle Tier...
%msbuild% /nologo /t:Rebuild /verbosity:quiet /p:Configuration=%configuration% ".\Demos\E4035-Middle Tier\E4035.sln"

echo Building WorkflowDemo...
%msbuild% /nologo /t:Rebuild /verbosity:quiet /p:Configuration=%configuration% ".\Demos\WorkFlowDemo\WorkFlowDemo.sln"
