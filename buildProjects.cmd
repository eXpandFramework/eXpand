...
%msbuild% /nologo /t:Rebuild /verbosity:quiet /p:Configuration=%configuration% ".\SecurityDemo\CS\SecurityDemo.Module\SecurityDemo.Module.csproj"
echo Building SecurityDemo.Module.Win...
%msbuild% /nologo /t:Rebuild /verbosity:quiet /p:Configuration=%configuration% ".\SecurityDemo\CS\SecurityDemo.Module.Win\SecurityDemo.Module.Win.csproj"
echo Building SecurityDemo.UiLevel.Win...
%msbuild% /nologo /t:Rebuild /verbosity:quiet /p:Configuration=%configuration% ".\SecurityDemo\CS\SecurityDemo.UiLevel.Win\SecurityDemo.UiLevel.Win.csproj"
echo Building SecurityDemo.Win...
%msbuild% /nologo /t:Rebuild /verbosity:quiet /p:Configuration=%configuration% ".\SecurityDemo\CS\SecurityDemo.Win\SecurityDemo.Win.csproj"
