...
{
    public class XpandXafGridView : DevExpress.ExpressApp.Win.Editors.XafGridView
    {
        ...
        public XpandXafGridView(DevExpress.ExpressApp.Win.Editors.GridListEditor gridListEditor)
        {
