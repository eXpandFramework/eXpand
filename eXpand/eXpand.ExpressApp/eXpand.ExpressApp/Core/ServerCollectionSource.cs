...
namespace eXpand.ExpressApp.Core
{
    public class LinqServerCollectionSource : ServerCollectionSource, ILinqCollectionSource
    {
        ...
        public LinqServerCollectionSource(ObjectSpace objectSpace, Type objectType) : base(objectSpace, objectType)
        {
        }


        public LinqServerCollectionSource(ObjectSpace objectSpace, Type objectType,IQueryable queryable) : base(objectSpace, objectType)
        {
            Query=queryable;
        }
