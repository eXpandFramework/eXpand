...
namespace eXpand.Tests.eXpand.WorldCreator.DbMapper
{
    ...
    public class When_a_column_is_nullable : With_Column {
        ...
        Because of = () => {
            _persistentAttributeInfos = new AttributeMapper(ObjectSpace, new DataTypeMapper()).Create(_column,Isolate.Fake.Instance<IPersistentMemberInfo>());
        };
    ...
    public class When_column_is_foreign:With_ForeignKey_Column {
        ...
        Because of = () => {
            _persistentAttributeInfos = new AttributeMapper(ObjectSpace, new DataTypeMapper()).Create(_column, Isolate.Fake.Instance<IPersistentMemberInfo>()).ToList();
        };
    ...
    public class When_column_is_primarykey_and_foreing_key_and_table_has_more_privae_keys_and_owner_is_struct:With_ForeignKey_Column
    {
        ...
        Because of = () => {
            _persistentAttributeInfos = new AttributeMapper(ObjectSpace, new DataTypeMapper()).Create(_column, _persistentMemberInfo);
        };
