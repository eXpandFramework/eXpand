...
namespace eXpand.ExpressApp.NCarousel.Web {
    public class NCarousel : eXpand.NCarousel.NCarousel, IPostBackEventHandler {
        ...
        Uri GetUrl(IPictureItem pictureItem)
        {
            ...
            if (!(string.IsNullOrEmpty(url)))
                return new Uri(url);
            if (UseNoImage){
                var webResourceUrl = ClientScriptProxy.Current.GetWebResourceUrl(GetType(), "eXpand.ExpressApp.NCarousel.Web.Resources.noimage.jpg");
