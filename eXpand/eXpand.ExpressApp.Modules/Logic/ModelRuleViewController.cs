...
namespace eXpand.ExpressApp.Logic{
    public abstract class ModelRuleViewController<TModelRuleAttribute, TModelRuleNodeWrapper,
                                                  TModelRuleInfo, TModelRule, TRulePermission> : ViewController
        ...
        where TRulePermission : RulePermission
    {
        ...
        public virtual void ForceExecution(bool isReady, View view, bool invertCustomization, ExecutionReason executionReason){
            if (isReady){
                ...
                foreach (TModelRule rule in ModelRuleManager<TModelRuleAttribute, TModelRuleNodeWrapper, TModelRuleInfo, TModelRule, TRulePermission>.Instance[view.ObjectTypeInfo])
        ...
        private void FrameOnViewChanging(object sender, EventArgs args){
            ...
            Active[ActiveObjectTypeHasRules] = ModelRuleManager<TModelRuleAttribute, TModelRuleNodeWrapper, TModelRuleInfo, TModelRule, TRulePermission>.HasRules(view);
        ...
        protected virtual void ForceExecutionCore(object currentObject, TModelRule rule, bool invertCustomization, View view, ExecutionReason executionReason){
            TModelRuleInfo info = ModelRuleManager<TModelRuleAttribute, TModelRuleNodeWrapper, TModelRuleInfo, TModelRule, TRulePermission>.CalculateModelRuleInfo(currentObject, rule);
            if (info != null){
