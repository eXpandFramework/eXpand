...
namespace eXpand.ExpressApp.WorldCreator.Core {
    public interface ITypesInfo {
        Type PersistentClassInfoInfoType { get; }
    ...
    public class TypesInfo : ITypesInfo {
        ...
        public void AddTypes(IEnumerable<Type> types)
        {
            ...
            PersistentClassInfoInfoType = GetInfoType(types, typeof(IPersistentClassInfo));
            ...
            PersistentKeyAttributeType = GetInfoType(types, typeof(IPersistentKeyAttribute));
            PersistentRuleRequiredFieldAttributeType = GetInfoType(types, typeof(IPersistentRuleRequiredFieldAttribute));
            PersistentSizeAttributeType = GetInfoType(types, typeof(IPersistentSizeAttribute));
        }
        ...
        public Type PersistentClassInfoInfoType { get; private set; }
        ...
        public Type PersistentSizeAttributeType { get; private set; }    
        ...
        public Type PersistentKeyAttributeType { get; private set; }
        public Type PersistentRuleRequiredFieldAttributeType { get; private set; }
