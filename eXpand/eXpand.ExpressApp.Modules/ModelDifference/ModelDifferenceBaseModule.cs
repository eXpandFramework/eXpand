...
//            application.LoggingOn += OnLoggingOn;
        ...
        void OnSetupComplete(object sender, EventArgs e) {
            ...
            new XpoModelDictionaryDifferenceStore(Application, true, GetPath(), customModelDifferenceStoreEventArgs.ExtraDiffStores).Load((ModelApplicationBase) Application.Model);            
        }

//        void ApplicationOnCreateCustomModelDifferenceStore(object sender, DevExpress.ExpressApp.CreateCustomModelDifferenceStoreEventArgs createCustomModelDifferenceStoreEventArgs) {
//            createCustomModelDifferenceStoreEventArgs.Handled = true;
//            var customModelDifferenceStoreEventArgs = new CreateCustomModelDifferenceStoreEventArgs();
//            OnCreateCustomModelDifferenceStore(customModelDifferenceStoreEventArgs);
//            createCustomModelDifferenceStoreEventArgs.Store = new XpoModelDictionaryDifferenceStore(Application, true, GetPath(), customModelDifferenceStoreEventArgs.ExtraDiffStores);            
//        }
