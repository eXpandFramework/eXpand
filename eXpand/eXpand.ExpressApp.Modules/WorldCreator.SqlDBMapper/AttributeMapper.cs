...
namespace eXpand.ExpressApp.WorldCreator.SqlDBMapper {
    public class AttributeMapper {
        ...
        IPersistentSizeAttribute GetPersistentSizeAttribute(Column column) {
            var persistentSizeAttribute = _objectSpace.CreateObjectFromInterface<IPersistentSizeAttribute>();
        ...
        IPersistentRuleRequiredFieldAttribute GetPersistentRuleRequiredFieldAttribute(Column column) {
            var persistentRuleRequiredFieldAttribute = _objectSpace.CreateObjectFromInterface<IPersistentRuleRequiredFieldAttribute>();
        ...
        IPersistentKeyAttribute GetPersistentKeyAttribute(Column column) {
            var persistentAttributeInfo = _objectSpace.CreateObjectFromInterface<IPersistentKeyAttribute>();
