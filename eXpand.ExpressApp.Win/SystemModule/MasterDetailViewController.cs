                ...
                @"<Element Name=""Application"">
                    ...
                    <Element Name=""Views"" >
                        <Element Name=""ListView"" >
                            <Attribute Name=""" + DetailListView + @""" RefNodeName=""{XAFPoint.ExpressApp.Core.DictionaryHelpers.ViewIdRefNodeProvider};ViewType=All|ListView"" />
                            <Attribute Name=""" + DetailListRelationName + @""" RefNodeName=""{XAFPoint.ExpressApp.Core.DictionaryHelpers.ViewIdRefNodeProvider};ClassName=@ClassName;Relations=All"" />
