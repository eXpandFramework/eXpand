                        ...
                        <Element Name=""ListView"" >
                            <Element Name=""" + PropertyPathFilters + @""">
                                <Element Name=""" + Filter + @""" Multiple=""True"" KeyAttribute=""ID"">
                                    ...
                                    <Attribute Name=""" + PropertyPathListViewId + @"""  Required=""True"" RefNodeName=""{XAFPoint.ExpressApp.Core.DictionaryHelpers.ViewIdRefNodeProvider};ViewType=All|ListView"" />
                                </Element>
                            </Element>
                        </Element>
                    </Element>
