...
//        [ModelReadOnly(typeof(ModelReadOnlDataStoreForeignKeyCreatedyCalculator))]
    ...
    public class ModelMemberOneToManyDomainLogic:ModelMemberExDomainLogicBase<IModelMemberOneToManyCollection> {
        ...
        public static IModelList<IModelMemberDataStoreForeignKeyCreated> Get_AssociatedMembers(IModelMemberOneToManyCollection modelMemberOneToManyCollection) {
            FastModelEditorHelper editorHelper=new FastModelEditorHelper();
            var memberOneToManyCollection = (ModelNode) modelMemberOneToManyCollection;

//            var isReadOnly = editorHelper.IsReadOnly(memberOneToManyCollection, "AssociatedMember");
//            var modelNode = ((ModelNode) modelMemberOneToManyCollection.AssociatedMember);
