...
namespace Xpand.ExpressApp.Xpo {
    public static class IXPSimpleObjectExtensions {
        public static XPCustomMemberInfo CreateCollection(this XPClassInfo classInfo, string propertyName, Type elementType, string criteria, params Attribute[] attributes) {
