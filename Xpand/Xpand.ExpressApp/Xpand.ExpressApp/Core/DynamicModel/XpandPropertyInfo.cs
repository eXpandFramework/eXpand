...
namespace Xpand.ExpressApp.Core.DynamicModel {
    public sealed class XpandPropertyInfo : PropertyInfo {
        ...
        public XpandPropertyInfo(PropertyInfo sourcePropertyInfo)
            : this(
        ...
        public XpandPropertyInfo(string name, Type propertyType, Type declaringType, bool canRead, bool canWrite) {
            nameCore = name;
