...
using Xpand.ExpressApp.ImportWiz.Settings;
using Xpand.ExpressApp.ImportWiz.Win.Forms;
    ...
    public partial class ExcelImportWizard : XtraForm
    {
        ...
        public Type Type
        {
            ...
            set
            {
                ...
                //Assign properties of the object that we're trying to import data to
        ...
        private void WizardControl_SelectedPageChanging(object sender, WizardPageChangingEventArgs e)
        {
            ...
            {
                e.Page = (MappingRadioGroup.SelectedIndex == 1) ?
            ...
            {
                e.Page = MappingRadioGroup.SelectedIndex == 1 ? wizardPage1 : wizardPage1;
            }
        ...
        private void InitWizPage1()
        {
            ...
            gridControl2_DataSourceChanged(null, null);
        ...
        private void gridControl2_DataSourceChanged(object sender, EventArgs e)
        {
            ...
            var bands = (MappingGrid.MainView as BandedGridView).Bands;
        ...
        private bool ignore_dt_changes = false;
        ...
        {
            (((sender as LookUpEdit).Parent as GridControl).MainView as GridView).PostEditor();
            (((sender as LookUpEdit).Parent as GridControl).MainView as GridView).UpdateCurrentRow();
        }
                            ...
                            if (val != null)
                            {
                                ...
                                if (prop.ReferenceType != null)
                                {
                                    ...
                                    if (prop.MemberType.IsSubclassOf(typeof(XPBaseObject)))
                                    {
                                        ...
                                        var mval = ImportWiz.Helper.GetXpObjectByKeyValue(objectSpace, text, typ);
