...
namespace Xpand.Persistent.BaseImpl.JobScheduler.Calendars{
    [AdditionalViewControlsRule("XpandCronCalendarHelp", "1=1", "1=1",
    ...
    public class XpandCronCalendar : XpandTriggerCalendar, ICronCalendar{
        ...
        public string CronExpression{
            ...
            set { SetPropertyValue("CronExpression", ref _cronExpression, value); }
        }

        string ITriggerCalendar.CalendarTypeFullName => "Quartz.Impl.Calendar.CronCalendar";
    }
}