...
{
    [DataContract]
    public abstract class UserBase<TRole> : ISecurityUser, ISecurityUserWithRoles, IAuthenticationStandardUser, IOperationPermissionProvider
        where TRole : IOperationPermissionsProvider
    {
