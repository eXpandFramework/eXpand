...
set XAFDirs=DevExpress.ExpressApp DevExpress.ExpressApp.Modules DevExpress.ExpressApp.Workflow DevExpress.ExpressApp.Design DevExpress.ExpressApp.Tools DevExpress.Persistent
